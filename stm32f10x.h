/** @attention <h2><center>&copy; COPYRIGHT 2016 STMicroelectronics</center></h2> Licensed under MCD-ST Liberty SW License Agreement V2, (the "License"); You may not use this file except in compliance with the License. You may obtain a copy of the License at: http://www.st.com/software_license_agreement_liberty_v2 Unless required by applicable law or agreed to in writing, software  distributed under the License is distributed on an "AS IS" BASIS,  WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied. See the License for the specific language governing permissions and limitations under the License.
@author  MCD Application Team
@version V3.6.4
@date    22-September-2016
CMSIS Cortex-M3 Device Peripheral Access Layer Header File.
This file contains all the peripheral register's definitions, bits definitions and memory mapping for STM32F10x Connectivity line, High density, High density value line, Medium density, Medium density Value line, Low density, Low density Value line and XL-density devices.
...
#define  USB_ADDR0_TX_ADDR0_TX               ((uint16_t)0xfffe)            /*!< Transmission Buffer Address 0 */ /*****************  Bit definition for USB_ADDR0_TX register  *****************/
#define  USB_ADDR1_TX_ADDR1_TX               ((uint16_t)0xfffe)            /*!< Transmission Buffer Address 1 */ /*****************  Bit definition for USB_ADDR1_TX register  *****************/
#define  USB_ADDR2_TX_ADDR2_TX               ((uint16_t)0xfffe)            /*!< Transmission Buffer Address 2 */ /*****************  Bit definition for USB_ADDR2_TX register  *****************/
#define  USB_ADDR3_TX_ADDR3_TX               ((uint16_t)0xfffe)            /*!< Transmission Buffer Address 3 */ /*****************  Bit definition for USB_ADDR3_TX register  *****************/
#define  USB_ADDR4_TX_ADDR4_TX               ((uint16_t)0xfffe)            /*!< Transmission Buffer Address 4 */ /*****************  Bit definition for USB_ADDR4_TX register  *****************/
#define  USB_ADDR5_TX_ADDR5_TX               ((uint16_t)0xfffe)            /*!< Transmission Buffer Address 5 */ /*****************  Bit definition for USB_ADDR5_TX register  *****************/
#define  USB_ADDR6_TX_ADDR6_TX               ((uint16_t)0xfffe)            /*!< Transmission Buffer Address 6 */ /*****************  Bit definition for USB_ADDR6_TX register  *****************/
#define  USB_ADDR7_TX_ADDR7_TX               ((uint16_t)0xfffe)            /*!< Transmission Buffer Address 7 */ /*****************  Bit definition for USB_ADDR7_TX register  *****************/

#define  USB_COUNT0_TX_COUNT0_TX             ((uint16_t)0x03ff)            /*!< Transmission Byte Count 0 */ /*****************  Bit definition for USB_COUNT0_TX register  ****************/
#define  USB_COUNT1_TX_COUNT1_TX             ((uint16_t)0x03ff)            /*!< Transmission Byte Count 1 */ /*****************  Bit definition for USB_COUNT1_TX register  ****************/
#define  USB_COUNT2_TX_COUNT2_TX             ((uint16_t)0x03ff)            /*!< Transmission Byte Count 2 */ /*****************  Bit definition for USB_COUNT2_TX register  ****************/
#define  USB_COUNT3_TX_COUNT3_TX             ((uint16_t)0x03ff)            /*!< Transmission Byte Count 3 */ /*****************  Bit definition for USB_COUNT3_TX register  ****************/
#define  USB_COUNT4_TX_COUNT4_TX             ((uint16_t)0x03ff)            /*!< Transmission Byte Count 4 */ /*****************  Bit definition for USB_COUNT4_TX register  ****************/
#define  USB_COUNT5_TX_COUNT5_TX             ((uint16_t)0x03ff)            /*!< Transmission Byte Count 5 */ /*****************  Bit definition for USB_COUNT5_TX register  ****************/
#define  USB_COUNT6_TX_COUNT6_TX             ((uint16_t)0x03ff)            /*!< Transmission Byte Count 6 */ /*****************  Bit definition for USB_COUNT6_TX register  ****************/
#define  USB_COUNT7_TX_COUNT7_TX             ((uint16_t)0x03ff)            /*!< Transmission Byte Count 7 */ /*****************  Bit definition for USB_COUNT7_TX register  ****************/
...
// ----------------------------------------------------------------------------------------------------------------------------------------- @blk  can: Controller Area Network
